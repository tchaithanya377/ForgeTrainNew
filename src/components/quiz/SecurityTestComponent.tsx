...
export const SecurityTestComponent: React.FC = () => {
  ...
  useEffect(() => {
    setDebugInfo({
      ...
      webkitFullscreenSupported: !!(document as any).webkitFullscreenEnabled,
      mozFullscreenSupported: !!(document as any).mozFullScreenEnabled,
      msFullscreenSupported: !!(document as any).msFullscreenEnabled,
  ...
  const exportDebugData = () => {
    ...
    a.href = url;
    a.download = `security-debug-${sessionId}.json`;
    a.click();
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="border rounded-lg p-4">
                ...
                <div className="text-sm">
                  ...
                  <div>Medium: <span className="text-yellow-600 font-semibold">{securityEvents.filter(e => e.severity === 'medium').length}</span></div>
                  <div>Low: <span className="text-blue-600 font-semibold">{securityEvents.filter(e => e.severity === 'low').length}</span></div>
                </div>
              </div>
              ...
              <div className="border rounded-lg p-4">
                ...
                <div className="space-y-1 text-sm">
                  ...
                  <div>Fullscreen: <span className="text-gray-600">{!!document.fullscreenElement ? 'Active' : 'Inactive'}</span></div>
                </div>
              </div>
            </div>
            ...
            <div className="border rounded-lg p-4 bg-blue-50">
              ...
              <div className="text-sm text-blue-700 space-y-1">
                <p>1. Click "Start Security Test" to activate the security monitor</p>
                <p>2. Use the test buttons to simulate various security violations</p>
                <p>3. Try switching tabs, right-clicking, or using keyboard shortcuts</p>
                <p>4. Monitor the event log for detected violations</p>
                <p>5. The system should terminate immediately on any violation (zero tolerance)</p>
                <p>6. Use "Export Debug Data" to save all information for analysis</p>
              </div>
            </div>
          </div>
        </CardContent>
